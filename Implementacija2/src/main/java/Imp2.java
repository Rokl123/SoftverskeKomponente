...
public class Imp2 implements DodelaTermina {
    ...
    public boolean createATerm(DayOfWeek day, LocalDateTime pocetakPerioda, LocalDateTime krajPerioda, Raspored r, Prostorija p, int startHour, int endMinutes,
                               int endHour,int endMinutes2){
            ...
            LocalDateTime period = LocalDateTime.of(pocetakPerioda.getYear(),pocetakPerioda.getDayOfMonth(), pocetakPerioda.getMonthValue(),startHour,endMinutes); // period 23.10.2023 do 24.1.2024
            LocalDateTime periodDo = LocalDateTime.of(pocetakPerioda.getYear(),pocetakPerioda.getDayOfMonth(), pocetakPerioda.getMonthValue(),endHour,endMinutes2);
